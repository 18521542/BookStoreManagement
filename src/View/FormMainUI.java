...
public class FormMainUI extends javax.swing.JFrame {

    Controller.AccountController controller;
    //create MainMenu
    private static FormMainUI instance = null;
    public Account InstanceUser=null;
    public static FormMainUI getInstance()
    {
        if(instance==null)
            instance=new FormMainUI();
        return instance;
    }
    ...
    private void  execute(){
        ...
        fbill = new Fbill();
        fOptions = new FOptions();
        fCashReceive = new FCashReceive();
        fBookReceive = new FImportBook();
        fBookInventory = new FBook();
        fCategoryAndPublisher = new FCategoryAndAuthor();
        ...
        MenuItem menuQLBH = new MenuItem(iconQLBH, "Quản lý bán hàng",null,menuQLBH_HD,menuQLBH_PTT,menuQLBH_LPN);
        
        //Create submenu Quản lý dữ liệu
        MenuItem menuQLDL_TCS = new MenuItem(iconMenu, "Dữ liệu sách",new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        MenuItem menuQLDL_TLvNXB = new MenuItem(iconMenu, "Thể loại & Tác giả",new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        MenuItem menuQLDL_KH = new MenuItem(iconMenu, "Khách hàng",new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        MenuItem menuQLDL = new MenuItem(iconQLKS, "Quản lý dữ liệu",null,menuQLDL_TCS,menuQLDL_TLvNXB,menuQLDL_KH);
        ...
        MenuItem menuQLNK_TNV = new MenuItem(iconMenu, "Thay đổi quy định",new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(InstanceUser.getType()==0){
                    switchPanel(ContentPanel, fOptions);
                    UserPanel.setVisible(false);
                }
                else{
                    JOptionPane.showMessageDialog(null, "You don't have permission to do this");
        ...
        MenuItem menuQLNS = new MenuItem(iconQLNS , "Nhân sự & quy định",null,menuQLNS_DSNV,menuQLNK_TNV);
        ...
        //Thêm vào menu chính
        addMenu(menuQLBH,menuQLDL,menuQLNS,menuQLTK);
    };
    ...
    private void initComponents() {
        ...
        Info_Label.setForeground(new java.awt.Color(0, 255, 0));
        ...
        Level_Info.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Name_Info.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Phone_Info.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Email_Info.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Addr_Info.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ContentPanel.setBackground(new java.awt.Color(51, 153, 255));
        ...
        HeadPanel.setBackground(new java.awt.Color(102, 51, 0));
    ...
    private void ButtonOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonOutActionPerformed
        ...
        if(response==JOptionPane.YES_OPTION){
            ...
            FormLogin.getInstance().setVisible(true);
        }
        else{
            //Không làm gì cả
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMainUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new FormMainUI().setVisible(true);
               
            }
        });
    }
    
    private FBook fBookInventory;
    private FImportBook fBookReceive;
    private FCashReceive fCashReceive;
    private FCategoryAndAuthor fCategoryAndPublisher;
